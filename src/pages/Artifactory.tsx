...
export const Artifactory = () => (
  <div className="space-y-10">
    <div className="flex items-center gap-5">
      <img src="/artifactory-logo.png" alt="Artifactory Nexus" className="h-20 w-20 shrink-0 object-contain drop-shadow-md" />
      <div>
        <img src="/artifactory-title.png" alt="Artifactory" className="h-10 object-contain object-left" />
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {tools.map((tool) => (
          ...
          >
            ...
            <p className="text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">{tool.description}</p>
