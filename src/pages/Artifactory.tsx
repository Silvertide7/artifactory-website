        ...
        {activeTab === "overview" && (
          <div className="space-y-5 p-6">
            <p className="text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">
              A D&D-style attunement system for Minecraft — fully data-driven and
              built for modpack makers who want deeper item progression and balance.
            </p>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
                Below are the default datapack attunement levels for the Diamond
                Sword, included as an example of what the system is capable of.
              </p>
                ...
                {[
                  {
                    ...
                    content: (
                      <>
                        Adds <Mod name="Invulnerable" color="sky" /> (won't despawn
                        and can't be hurt by environmental effects) along with the
                        base benefits of the attunement bond.
                      </>
                    ),
                  },
                  {
                  ...
                  },
                  {
                    ...
                    content: (
                      <>
                        ...
                        <Mod name="Soulbound" color="amber" /> — it travels with
                        you through death and respawns on your body.
                      </>
                    ),
                  },
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                Each attunement level grants modifications and attribute bonuses to
                the item. Benefits are cumulative — a level 3 item retains
                everything granted at levels 1 and 2. Placing an attuned item back
                into the Nexus re-syncs all modifications, so datapack changes take
                effect immediately.
              </p>
              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  {
                    name: "Unbreakable",
                    border: "border-violet-200 bg-violet-50 dark:border-violet-900/60 dark:bg-violet-950/20",
                    label: "text-violet-500 dark:text-violet-400",
                    desc: "If the item has durability, it becomes unbreakable.",
                  },
                  {
                    name: "Soulbound",
                    border: "border-amber-200 bg-amber-50 dark:border-amber-900/60 dark:bg-amber-950/20",
              ...
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                Any attribute — including those added by other mods — can be applied
                at each attunement level using the format:{" "}
                <code className="font-mono text-xs">attribute/modid:name/operation/value/slot</code>.
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                Items can be configured to require attunement before they can be
                used at all — no damage, no block breaking, no drawing a bow,
                nothing. This lets modpack makers lock powerful items behind
                meaningful progression gates.
              </p>
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                Once attuned, an item shows complete allegiance to its owner. Other
                players cannot use it in any capacity. You can also configure
                effects that are applied to players who attempt to hold an item that
                doesn't belong to them — slowness, poison, wither, or anything you
                choose.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                ...
                slot is added. Only items you are attuned to can be placed here —
                use it to store attuned items you aren't actively using for quick
                swapping. <Mod name="Soulbound" color="amber" /> items will stay in
                this slot on death.
              </p>
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
          ...
          <div className="divide-y divide-zinc-100 dark:divide-zinc-600">
            ...
            <div className="space-y-4 p-6">
              ...
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                ...
                attunement slots it will reserve. If the item has a chance of being
                attunable (e.g. 40%) that percentage is displayed — determined the
                first time you place it in the Nexus. If attunement is required
                before use, the item cannot deal damage, break blocks, or be used in
                any capacity until attuned.
              </p>
              <div className="flex justify-center">
                <figure className="space-y-2">
                  <img
            ...
            <div className="space-y-4 p-6">
              ...
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                The Attunement Nexus is where all attunements are performed. Craft
                it using the default recipe:
              </p>
              <div className="flex justify-center">
                <figure className="space-y-2">
                  <img
            ...
            <div className="space-y-4 p-6">
              ...
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                Place an attunable item in the center slot to see its details and
                requirements. If you meet all requirements, you can start the
                attunement process — which will consume any required XP levels and
                items then bond the item to you.
              </p>
              <div className="flex justify-center">
                <img
                  src={IMG.nexusUI}
            ...
            <div className="space-y-4 p-6">
              ...
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                ...
                Attunements screen. Open it via the cog wheel in the Attunement
                Nexus, or press the hotkey (default{" "}
              ...
              <div className="rounded-lg border border-rose-200 bg-rose-50 px-4 py-3 dark:border-rose-900/60 dark:bg-rose-950/20">
                <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                  ...
                  attunement benefits (enchantments and modifications from other
                  mods are kept) and returns your slots. The item can be attuned to
                  again by anyone.{" "}
        ...
        {activeTab === "datapack" && (
          <div className="space-y-6 p-6">
            <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
              ...
              . Use the JSON Builder tool (top right) to generate files with live
      ...
      "requirements": {
        ...
        "items": ["minecraft:dragon_egg"]
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                Define unique attunement configurations on individual item stacks
                using the{" "}
                <code className="rounded bg-zinc-100 px-1.5 py-0.5 font-mono text-xs dark:bg-zinc-600">
                  artifactory:attunement_override
                </code>{" "}
                data component. Works with{" "}
                <code className="font-mono text-xs">/give</code>, advancements,
                loot tables, KubeJS, and more. This overrides any datapack config
                for that item type, allowing unique one-off items with their own
                attunement rules.
              </p>
  ...
  attunement_levels: [{
    ...
    modifications: [invulnerable, unbreakable, soulbound]
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400">
                This creates a mace with a 50% chance of being attunable, using 5
                slots, requiring 64 diamonds, and granting all three core
                modifications on attunement.
              </p>
            </div>
          </div>
        )}
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">
              Generate attunement config files with live validation and preview.
            </p>
          </div>
