...
export const Tooltip = ({ content }: TooltipProps) => (
  <span className="group relative inline-flex items-center">
    ...
    <span
      role="tooltip"
      className="pointer-events-none absolute bottom-full left-1/2 z-50 mb-3 w-72 -translate-x-1/2 break-all rounded-xl bg-slate-800 px-3.5 py-2.5 text-xs leading-relaxed text-slate-100 shadow-2xl opacity-0 transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100"
    >
      {content}
